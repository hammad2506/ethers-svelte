...
//All data from the above source has been formatted as object for fast lookup
//Object key = Chain Id
...
export default {
  ...
  19: {
    ...
    chainId: 19,
    networkId: 19,
    explorers: [{ name: "blockscout", url: "https://songbird-explorer.flare.network", standard: "none" }],
  },
  20: {
  ...
  29: {
    ...
    chainId: 29,
    networkId: 29,
    explorers: [{ name: "Genesis L1 blockchain explorer", url: "https://explorer.genesisl1.org/", standard: "none" }],
  },
  30: {
    name: "RSK Mainnet",
    chain: "RSK",
  ...
  96: {
    ...
    chainId: 96,
    networkId: 96,
    explorers: [{ name: "Next Smart Chain Explorer", url: "https://explorer.nextsmartchain.com", standard: "none" }],
  },
  97: {
  ...
  100: {
    ...
    networkId: 100,
    slip44: 700,
    explorers: [{ name: "blockscout", url: "https://blockscout.com/poa/xdai", standard: "EIP3091" }],
  },
  101: {
    name: "EtherInc",
    chain: "ETI",
  ...
  262: {
    ...
    networkId: 1,
    icon: "SUR",
    explorers: [{ name: "Surnet Explorer", url: "https://explorer.surnet.org/", icon: "SUR", standard: "EIP3091" }],
  },
  269: {
  ...
  336: {
    ...
    chainId: 336,
    networkId: 336,
    explorers: [{ name: "subscan", url: "https://shiden.subscan.io", standard: "none" }],
  },
  338: {
    name: "Cronos Testnet",
    chain: "CRO",
    ...
    chainId: 338,
    networkId: 338,
    explorers: [{ name: "Cronos Testnet Explorer", url: "https://cronos.crypto.org/explorer/testnet3", standard: "none" }],
  },
  361: {
    name: "Theta Mainnet",
    chain: "Theta",
  ...
  363: {
    ...
    chainId: 363,
    networkId: 363,
    explorers: [{ name: "Theta Sapphire Testnet Explorer", url: "https://guardian-testnet-sapphire-explorer.thetatoken.org", standard: "EIP3091" }],
  },
  364: {
    ...
    chainId: 364,
    networkId: 364,
    explorers: [{ name: "Theta Amber Testnet Explorer", url: "https://guardian-testnet-amber-explorer.thetatoken.org", standard: "EIP3091" }],
  },
  365: {
    name: "Theta Testnet",
    chain: "Theta",
    ...
    chainId: 365,
    networkId: 365,
    explorers: [{ name: "Theta Testnet Explorer", url: "https://testnet-explorer.thetatoken.org", standard: "EIP3091" }],
  },
  369: {
  ...
  880: {
    ...
    chainId: 880,
    networkId: 880,
    explorers: [{ name: "Ambros Chain Explorer", url: "https://explorer.ambroschain.com", standard: "none" }],
  },
  888: {
    name: "Wanchain",
    chain: "WAN",
  ...
  8080: {
    ...
    chainId: 8080,
    networkId: 8080,
    explorers: [{ name: "GeneChain Adenine Testnet Scan", url: "https://scan-testnet.genechain.io", standard: "EIP3091" }],
  },
  8217: {
  ...
  8888: {
    ...
    chainId: 8888,
    networkId: 8888,
    explorers: [{ name: "Ambros Chain Explorer", url: "https://testexplorer.ambroschain.com", standard: "none" }],
  },
  8995: {
    name: "bloxberg",
    chain: "bloxberg",
  ...
  9000: {
    ...
    networkId: 9000,
    explorers: [
      { name: "Evmos EVM Explorer (Blockscout)", url: "https://evm.evmos.org", standard: "none" },
      { name: "Evmos Cosmos Explorer (Big Dipper)", url: "https://explorer.evmos.org", standard: "none" },
    ],
  },
  9999: {
    name: "myOwn Testnet",
  ...
  31337: {
    ...
    networkId: 31337,
    slip44: 6060,
    explorers: [{ name: "GoChain Testnet Explorer", url: "https://testnet-explorer.gochain.io", standard: "EIP3091" }],
  },
  32659: {
    name: "Fusion Mainnet",
    chain: "FSN",
  ...
  197710212030: {
    ...
    icon: "ntity",
    explorers: [{ name: "Ntity Blockscout", url: "https://blockscout.ntity.io", icon: "ntity", standard: "EIP3091" }],
  },
  197710212031: {
    ...
    icon: "ntity",
    explorers: [{ name: "Ntity Haradev Blockscout", url: "https://blockscout.haradev.com", icon: "ntity", standard: "EIP3091" }],
  },
  6022140761023: {
